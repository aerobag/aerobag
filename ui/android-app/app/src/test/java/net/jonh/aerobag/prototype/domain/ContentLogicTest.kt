...
private class FakeNativeBridge(
    ...
    override fun registerOwnshipSourceInSessionJson(handle: Long, registrationJson: String): String =
        getSessionSnapshotJson(handle)

    override fun updateOwnshipSourceStatusInSessionJson(handle: Long, updateJson: String): String =
        getSessionSnapshotJson(handle)
    ...
    override fun engageMapFollowInSessionJson(handle: Long, viewportJson: String): String =
        getSessionSnapshotJson(handle)

    override fun disengageMapFollowInSessionJson(handle: Long, viewportJson: String): String =
        getSessionSnapshotJson(handle)

    override fun setMapFollowOffsetInSessionJson(
        handle: Long,
        viewportJson: String,
        offsetXPx: Double,
        offsetYPx: Double,
