...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 Platform code exposes generic artifact bytes or zip member access without nav-db-specific interpretation.
- [ ] #2 Core opens and validates nav-db artifacts.
- [ ] #3 Artifact unreadability is reported by core through a recoverable boundary error.
<!-- AC:END -->
