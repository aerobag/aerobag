...
export const RELEASE_JOURNEYS = Object.freeze([
  ...
  journey("shared.flight-plan-edit-and-navigate", "p0", shared, [
    ...
    "plan.stop-navigation", "plan.start-navigation", "plan.suspend-sequencing",
  ...
  journey("shared.inspector-details", "p1", shared, [
    "inspector.airport-priority", "inspector.spot-selection", "inspector.distance-live",
