...
# Four GiB leaves ample room for CI's bounded offline-package fixtures without
# making a fresh AVD require roughly 20 GiB of free host storage before boot.
