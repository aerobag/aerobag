...
- Web fetches the package member requests returned by core under the publication contract (`/packages/...` for web, installed package storage for Android) and does not parse the payload.
