    ...
    Check(
        ...
        allow=(
            AllowRule(
                ...
                None,
                "scheduled core work",
                "The retained runner is the only approved path for scheduled session work.",
            ),
            AllowRule(
                "MapExplorerPage.kt",
    ...
    Check(
        ...
        allow=(
            ...
            AllowRule(
                ...
                None,
                "background IO/render",
                "Plate resource callbacks execute in the retained runner and bitmap decoding resumes on Dispatchers.IO.",
            ),
        ),
    ),
    Check(
        ...
        allow=(
            AllowRule(
                ...
                None,
                "scheduled core work",
                "Resource-paging UI work must go through the retained session work runner.",
            ),
        ),
    ),
    Check(
