...
function workerBackedSession(client: AppCoreWorkerClient, sessionId: number, initialSnapshot: UiSessionSnapshot): UiSession {
  ...
  return {
    ...
    performAirwayPickerAction: (...args) => updateSnapshot(call("performAirwayPickerAction", args)),
    ...
    performFlightPlanControl: (...args) => updateSnapshot(call("performFlightPlanControl", args)),
    flightPlanRowActionDecision: (...args) => call("flightPlanRowActionDecision", args),
    ...
    performFlightDataBannerCellAction: (...args) => updateSnapshot(call("performFlightDataBannerCellAction", args)),
    performFlightDataCommand: (...args) => updateSnapshot(call("performFlightDataCommand", args)),
    performMapInspectionCommand: (...args) => updateSnapshot(call("performMapInspectionCommand", args)),
    performFlightPlanColumnAction: (...args) => updateSnapshot(call("performFlightPlanColumnAction", args)),
    statusActionDecision: (...args) => call("statusActionDecision", args),
    performStatusAction: (...args) => updateSnapshot(call("performStatusAction", args)),
    mapSelectionActionDecision: (...args) => call("mapSelectionActionDecision", args),
    performMapSelectionUiAction: (...args) => updateSnapshot(call("performMapSelectionUiAction", args)),
    ...
    performAircraftLibraryAction: (...args) => updateSnapshot(call("performAircraftLibraryAction", args)),
