...
PACKAGE_SOURCE_PORT="${PACKAGE_SOURCE_PORT:-8092}"
ANDROID_PACKAGE_SOURCE_BASE_URL="${ANDROID_PACKAGE_SOURCE_BASE_URL:-http://127.0.0.1:${PACKAGE_SOURCE_PORT}}"
