...
pub use map_overlay::{
    ...
    project_nav_symbol_feature, query_map_overlay, query_map_overlay_with_point_display_scale,
    query_map_selection, query_map_selection_with_point_display_scale, tile_key,
