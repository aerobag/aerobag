...
pub(crate) const MAX_SID_ENROUTE_TRANSITION_DISPLAY_ELEMENT_DISTANCE_NM: f64 = 500.0;
pub(crate) const MAX_STAR_ENROUTE_TRANSITION_DISPLAY_ELEMENT_DISTANCE_NM: f64 = 500.0;
...
pub(crate) const EXPLICIT_PUBLISHED_TURN_SOURCE_PREFIX: &str = "explicit_published_turn@";
