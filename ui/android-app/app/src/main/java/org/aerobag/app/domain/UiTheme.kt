...
data class ControlsTheme(
    ...
    val buttonFg: Color,
    val controlGroupBg: Color,
    val textInputBg: Color,
    val buttonIconSecondary: Color,
    val panelBg: Color,
    ...
    val dataStatusOkBg: Color,
    val dataStatusOkStroke: Color,
    val dataStatusInfoBg: Color,
    val dataStatusInfoStroke: Color,
    val dataStatusCautionBg: Color,
    val dataStatusCautionStroke: Color,
    val dataStatusWarningBg: Color,
    val dataStatusWarningStroke: Color,
    val dataStatusUnavailableBg: Color,
    val dataStatusUnavailableStroke: Color,
...
data class AviationTheme(
    ...
    val altitudeIntercept: Color,
    val traffic: Color,
    val trafficContrast: Color,
    val trafficLabel: Color,
    val darkGray: Color,
    ...
    val airportRunwayPattern: Color,
)
...
private data class WireControlsTheme(
    ...
    val control_group_bg: String,
    val text_input_bg: String,
    val button_icon_secondary: String,
    val panel_bg: String,
    ...
    val data_status_ok_bg: String,
    val data_status_ok_stroke: String,
    val data_status_info_bg: String,
    val data_status_info_stroke: String,
    val data_status_caution_bg: String,
    val data_status_caution_stroke: String,
    val data_status_warning_bg: String,
    val data_status_warning_stroke: String,
    val data_status_unavailable_bg: String,
    val data_status_unavailable_stroke: String,
...
private data class WireAviationTheme(
    ...
    val altitude_intercept: String,
    val traffic: String,
    val traffic_contrast: String,
    val traffic_label: String,
    ...
    val airport_runway_pattern: String,
)
    ...
    fun load(context: Context): UiTheme {
        ...
        return UiTheme(
            controls = ControlsTheme(
                ...
                controlGroupBg = wire.controls.control_group_bg.toColor(),
                textInputBg = wire.controls.text_input_bg.toColor(),
                buttonIconSecondary = wire.controls.button_icon_secondary.toColor(),
                ...
                dataStatusOkBg = wire.controls.data_status_ok_bg.toColor(),
                dataStatusOkStroke = wire.controls.data_status_ok_stroke.toColor(),
                dataStatusInfoBg = wire.controls.data_status_info_bg.toColor(),
                dataStatusInfoStroke = wire.controls.data_status_info_stroke.toColor(),
                dataStatusCautionBg = wire.controls.data_status_caution_bg.toColor(),
                dataStatusCautionStroke = wire.controls.data_status_caution_stroke.toColor(),
                ...
                dataStatusUnavailableBg = wire.controls.data_status_unavailable_bg.toColor(),
                dataStatusUnavailableStroke = wire.controls.data_status_unavailable_stroke.toColor(),
            ...
            aviation = AviationTheme(
                ...
                altitudeIntercept = wire.aviation.altitude_intercept.toColor(),
                traffic = wire.aviation.traffic.toColor(),
                trafficContrast = wire.aviation.traffic_contrast.toColor(),
                trafficLabel = wire.aviation.traffic_label.toColor(),
                ...
                airportRunwayPattern = wire.aviation.airport_runway_pattern.toColor(),
            ),
            flightPlanRoute = FlightPlanRouteTheme(
                ...
                guidanceArrow = wire.flight_plan_route.guidance_arrow.toColor(),
