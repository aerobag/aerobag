...
interface NativeBridge {
    ...
    fun performFlightDataCommandInSessionJson(handle: Long, commandJson: String): String
    ...
    fun reportLiveFeedAcquisitionPhaseInSessionJson(
        handle: Long,
        product: String,
        phase: String,
    ): String
...
object NativeBindings : NativeBridge {
    ...
    external override fun performFlightDataCommandInSessionJson(handle: Long, commandJson: String): String
    ...
    external override fun reportLiveFeedAcquisitionPhaseInSessionJson(
        handle: Long,
        product: String,
        phase: String,
    ): String
