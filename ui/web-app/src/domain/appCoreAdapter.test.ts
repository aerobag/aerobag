...
describe("loadBestAvailableAdapter", () => {
  ...
  it("uses the wasm adapter when the generated module exports the expected API", async () => {
    const loaded = await loadBestAvailableAdapter(async () => ({
      ...
      ingest_tafs_in_session: async () => {},
      get_map_overlay_in_session: async () => "{\"state\":\"complete\",\"result\":{\"visible_features\":[],\"visible_metars\":[],\"visible_pireps\":[],\"needed_point_tiles\":[],\"needed_metar_tiles\":[],\"needed_metars\":false,\"needed_airspace_ref_tiles\":[],\"needed_airspace_features\":[],\"needed_airspace_label_tiles\":[],\"needed_tfrs\":false,\"airspace_paths\":[],\"tfr_paths\":[],\"airspace_labels\":[],\"warnings\":[]}}",
