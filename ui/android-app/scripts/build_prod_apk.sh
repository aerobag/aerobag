...
ANDROID_VERSION_NAME="${ANDROID_VERSION_NAME:-${AEROBAG_VERSION_NAME:-0.1.$BUILD_STAMP_UTC+$BUILD_ID}}"
...
env \
  ...
  AEROBAG_SERVICE_BULLETIN_URLS="${AEROBAG_SERVICE_BULLETIN_URLS:-https://aerobag.org/service/bulletins-v1.json}" \
