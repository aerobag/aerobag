...
Add health monitoring for the preprocessing pipeline: whether charts and live-feed products arrive on time, latency, gaps, and enough data to tune poll periods. Should include warning signals like - unexpected surprises/validator violations in procedure geometry generation - poor color match in nexrad palettization
...
- [ ] #2 Monitor live-feed product latency and gaps.
